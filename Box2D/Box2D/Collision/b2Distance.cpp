...
void b2DistanceProxy::Set(const b2Vec2* vertices, int32_t count, double radius)
{
    m_vertices = vertices;
    m_count = count;
    m_radius = radius;
...
void b2Simplex::Solve3()
{
	...
	// a3 = 0
	b2Vec2 e12 = w2 - w1;
	double w1e12 = b2Dot(w1, e12);
	double w2e12 = b2Dot(w2, e12);
	double d12_1 = w2e12;
	double d12_2 = -w1e12;
	...
	// a2 = 0
	b2Vec2 e13 = w3 - w1;
	double w1e13 = b2Dot(w1, e13);
	double w3e13 = b2Dot(w3, e13);
	double d13_1 = w3e13;
	double d13_2 = -w1e13;
	...
	// a1 = 0
	b2Vec2 e23 = w3 - w2;
	double w2e23 = b2Dot(w2, e23);
	double w3e23 = b2Dot(w3, e23);
	double d23_1 = w3e23;
	double d23_2 = -w2e23;
	
	// Triangle123
	double n123 = b2Cross(e12, e13);

	double d123_1 = n123 * b2Cross(w2, w3);
	double d123_2 = n123 * b2Cross(w3, w1);
	double d123_3 = n123 * b2Cross(w1, w2);
