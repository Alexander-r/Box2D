...
b2Vec2 b2MotorJoint::GetReactionForce(double inv_dt) const
{
	return inv_dt * m_linearImpulse;
}

double b2MotorJoint::GetReactionTorque(double inv_dt) const
{
	return inv_dt * m_angularImpulse;
}

void b2MotorJoint::SetMaxForce(double force)
{
	b2Assert(b2IsValid(force) && force >= 0.0);
	m_maxForce = force;
}

double b2MotorJoint::GetMaxForce() const
{
	return m_maxForce;
}

void b2MotorJoint::SetMaxTorque(double torque)
{
	b2Assert(b2IsValid(torque) && torque >= 0.0);
	m_maxTorque = torque;
}

double b2MotorJoint::GetMaxTorque() const
{
	return m_maxTorque;
}

void b2MotorJoint::SetCorrectionFactor(double factor)
{
	b2Assert(b2IsValid(factor) && 0.0 <= factor && factor <= 1.0);
	m_correctionFactor = factor;
}

double b2MotorJoint::GetCorrectionFactor() const
{
...
void b2MotorJoint::SetAngularOffset(double angularOffset)
{
...
double b2MotorJoint::GetAngularOffset() const
{
