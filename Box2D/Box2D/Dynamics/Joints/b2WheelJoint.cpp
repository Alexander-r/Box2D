...
float b2WheelJoint::GetPrismaticJointTranslation() const
{
	b2Body* bA = m_bodyA;
	b2Body* bB = m_bodyB;
...
float b2WheelJoint::GetPrismaticJointSpeed() const
{
    b2Body* bA = m_bodyA;
    b2Body* bB = m_bodyB;
...
float b2WheelJoint::GetRevoluteJointAngle() const
{
    b2Body* bA = m_bodyA;
    b2Body* bB = m_bodyB;
...
float b2WheelJoint::GetRevoluteJointSpeed() const
{
